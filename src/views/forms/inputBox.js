...
export const InputBox = ({ type = 'text', name = 'textBoxName', value = '', error, touched = '', disabled = false, margin = "normal", feedbackInvalid = 'Input is required!', size = 'sm', placeholder = 'Enter data', id = 'validationInput', ...props }) => {
