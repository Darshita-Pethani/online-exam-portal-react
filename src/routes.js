...
// user exam list
const studentDashboardExamList = React.lazy(() => import('./views/pages/userExamList/index'));
...
const routes = [
  ...
  // user exam list
  { path: 'pages/user/exam/list', name: 'user exam list', element: studentDashboardExamList },
]
